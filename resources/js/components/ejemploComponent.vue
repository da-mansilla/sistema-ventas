<template>
		<div class="card-content card w-100">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Escrdasdadasdasio</a></li>
            </ol>
    ...
    export default {
        ...
        methods : {
            listarArticulo (page,buscar,criterio){
            	...
            	this.arrayArticulo= [{
					'articulo.nombre': 'remera azul',
                    'articulo.categoria': 'remeras',
                    'articulo.stock': '20',
                    'articulo.precio': '200',
                    'articulo.n_serie': '456789153'
